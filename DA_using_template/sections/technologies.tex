...
damalig verwendeten UPC Barcodes(sh. Abbildung 11). Anwendungsfälle für QR-Codes sind Produkt-Tracking, Item-Identifikation, Dokumentenmanagement, etc. .
Ein QR-Code besteht aus schwarzen Quadraten welche in einem großen Quadrat arrangiert werden(sh. Abbildung 10).
...
potenzielle Kunde dazu eingeladen einfach sein Smartphone herauszuholen und einfach den QR-Code zu Scannen um 
...
Hier ist ein einfaches Beispiel wie man qrcode.js in eine Webseite einfügen kann.
