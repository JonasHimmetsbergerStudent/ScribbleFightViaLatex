...
Ein Stand-alone-Programm ist ein Programm, dass selbständig ohne Hilfsmittel ausgeführt werden kann.
Das Web-Game sollte kein Stand-alone-Programm werden, sondern im Browser spielbar sein. Deswegen wurde JavaScript für die Programmierung am Client, sowie auch am Server ausgewählt.
...
Kollisionserkennung, sowie auch Funktionen für Maus- und Tastatur-Interaktionen.
...
Ein schneller Weg um p5.js einzubinden, ist auf ein JavaScript File online zu verweisen.
...
\end{lstlisting}
Alternativ kann die p5.js Library aber auch
...
Zwischen p5.js und Processing, eine Programmiersprache, die als eine stark vereinfachte Version von Java definiert werden kann, bestehen viele Ähnlichkeiten.
...
\begin{compactitem}
    ...
    \item Das Programm ist nicht nur lokal auf dem eigenen Gerät verfügbar, was das Teilen sehr viel einfacher macht
...
Die kostenlosen Bibliotheken, dabei in Verwendung sind, werden im Folgenden gelistet und näher
erklärt.
...
Aus diesen Gründen wurde der Teil der Bild- und Maperkennung, welche
...
=======
\subsubsection{2. Erwartungen}
Dieses Prinzip soll dem Zuschauer einen Hinweis darauf geben welche Aktion als nächstes passiert. Außerdem soll dies die Aktion mehr realistischer machen.
Das klassische Beispiel hierzu ist ein Sprung. Bevor der Charakter in die Luft springt muss er sich erst nach unten beugen, um Energie aufzubauen. Dies kann mit einer Feder verglichen werden, welche zusammengedrückt wird, und dann schnell losgelassen wird (Abbildung \ref{fig:tech:Spring}).
>>>>>>> 0aa351d3e64f3e12d57bc3db4c08b73de013183f
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.18]{pics/sad.png}
