...
vom Wort dataflow). Tensoren sind besser bekannt als Skalare, Vektoren oder Matrizen. Tensoren sind also
null-, ein- oder mehrdimensionale Daten-Tupel.
Dabei bietet TensorFlow alles
von on der effizienten Ausführung von
Befehlen auf der CPU, oder GPU, über der Skalierung von Berechnungen auf viele Endgeräte bis hin
zur Visualisierung der gelernten Daten mittels TensorBoard.
Auf diese open-source machine learning platform baut auch Keras auf. Kreas ist eine deep-learning
