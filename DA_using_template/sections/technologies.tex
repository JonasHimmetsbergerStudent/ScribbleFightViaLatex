...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{pics/index html.PNG}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{pics/SocketIO_client.PNG}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{pics/SocketIO_server.PNG}
...
Die folgenden Absätze beziehen sich auf die Quellen \cite{qrCodeWiki} \cite{qrCode.js}.
...
\subsection{Chart.js [W]}  \label{ChartJs}
...
\textit{https://github.com/chartjs/Chart.js} heruntergeladen werden. Chart.js stellt einem sehr
...
\begin{figure}[H]
  ...
  \caption{Code für logarithmische Darstellung}
\end{figure}
...
Ist es notwendig ein Diagramm zu aktualisieren kann dies mit folgenden Funktionen umgesetzt werden. Zum Hinzufügen
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{pics/hexapawn/hexapawn_setup.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{pics/erzeugen.png}
...
Um die Ebene zu spiegeln oder auf den Kopf zu stellen kann der Befehl 'Horizontal Spiegeln' bzw. 'Um 180° drehen' benutzt werden.

Damit die aufgezogenen Flächen die richtige Farbe haben, kann das Icon für den Farbwähler gewählt werden. Dieses öffnet ein Fenster. Bei diesem kann die gewünschte Farbe entweder in Hexadezimalcode oder in RGB (Red,Green,Blue) angegben werden.
Die Farbe kann aber auch manuell ausgewählt werden oder mit dem ``Pipetten-Werkzeug'' (Shortcut ``I'') ausgesucht werden.
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{pics/color.png}
  \caption{Farbwähler}
\end{figure}


\subsection{12 Prinzipien der Animation}
Die Informationen zu diesem Kapitel wurden in Quelle \cite{principles} in Erfahrung gebracht.
...
Die Grundlagen dieser Prinzipien bestehen darin, Animationen zu erzeugen, welche den Gesetzen der Physik folgen.
...
Dieses Prinzip soll dem Zuschauer einen Hinweis darauf geben welche Aktion als nächstes passiert. Außerdem soll dies die Aktion mehr realistisch machen.
...
Staging ist die unmissverständliche Präsentation einer Idee oder einer Aktion. Dieses Prinzip ist sehr breit gefächert, weil es so viele verschiedene
...
Ein Tipp für Anfänger ist es, nur Würfel, Quader und Kreise zum Designen von Charakteren zu verwenden.
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{pics/solidDrawing.png}
  \caption{Solid Drawing}
\end{figure}
