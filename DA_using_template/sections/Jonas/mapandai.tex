...
Es ist jedoch möglich dieses Programm so zu erweitern, dass dieses auch dazulernt. Dies lässt sich mit folgendem Code implementieren.
...
\begin{compactenum}
    ...
    \item reset(): die vierte und letzte Funktion ist Reset(\dots). Diese wird dazu verwendet um nach einer Episode die Umgebung und alle dazugehörigen Variablen auf einen gewünschten Stand zurückzusetzen.
\end{compactenum}
