...
JONAS AAAAAAAAAAAAAAAAAAAAAAAAAAA SCHREIB MI NU UM:

Die mittlere Größenordnung der Policenverlustfunktion.
Korreliert damit, wie stark sich die Richtlinie (Prozess zur Entscheidungsfindung) ändert.
Das Ausmaß sollte während einer erfolgreichen Trainingseinheit abnehmen.
Diese Werte werden während des Trainings oszillieren. Im Allgemeinen sollten sie kleiner als 1,0 sein.
