...
Im folgenden werden die zwei Reinforcement Learning Algorithmen ``A2C'' und ``PPO'' verglichen und die besten Ergebnisse der Modelle
präsentiert.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=1]{pics/Tensorboard/A2C/entropy_loss.png}
