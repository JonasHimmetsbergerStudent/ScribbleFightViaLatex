...
Die mit OpenAI-Gym und Stable Baselines3 erlernten Modelle können via einem ``TensorBoard'' analysiert werden.

Die Graphen, welche aus den Modellen entsprungen sind zeigen, dass der A2C Algorithmus für
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=1.1]{pics/Tensorboard/A2C/entropy_loss.png}
    \caption{Entropie Verlust}
    \label{fig:a2c:entropyloss}
\end{figure}

Dass die Künstliche Intelligenz durch den A2C Algorithmus nicht dazugelernt hat,
wird klar erkennbar, wenn der Verlauf der Lernrate im Intervall von 0 bis 22.000 Schritte konstant auf dem Wert null bleibt.
Die folgende Funktion stellt die Lernrate der ``ScribbleFight'' Künstlichen Intelligenz dar; es wurde der A2C Algorithmus angewandt.
...
Auch im Falle des Wertverlusts ist ein klarer Trend erkennbar, welcher für sich spricht.
...
Aus diesen Graphen ist es klar ersichtlich, dass der A2C Algorithmus nicht für diesen Anwendungsfall geeignet ist.
