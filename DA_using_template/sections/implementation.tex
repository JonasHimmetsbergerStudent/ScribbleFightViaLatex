...
Grundbausteinen eines simplen Websocket-Spiels gebaut. 
Dieses kann unter \cite{gameLobby} gefunden werden.
gefunden werden. Auf das Spiel wird hier nicht eingegangen, da für 
diese Arbeit nur die Lobby relevant ist. Das Lobbysystem dieses Spiels hat 4 Funktionen, welche später in ähnlicher Form in der ScribbleFight Lobby verwendet wurden: ``connect'', ``create'', ``join'' und ``play''.
